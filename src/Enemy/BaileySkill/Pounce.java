...
public class Pounce extends EnemySkill {
	...
	private static final double MANA_COST = 10, COOLDOWN = 9000, ATTACK_RATIO = 1.75, DISTANCE = 600, RADIUS = 300,
			FLY_TIME = 250;

	private BossBailey p;

	private double flying = 0;

	private boolean done = true;

	public Pounce(BossBailey p) {
		this.p = p;
