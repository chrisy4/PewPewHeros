...
public class DeathCloud extends Skill {
	...
	private static final double ATTACK_BOOSTED_PER_SECOND = 2.25, ATTACK_NORMAL_PER_SECOND = 0.5, MANA_COST = 30,
	...
	public String getInfo() {
		return String.format(
				"Death Cloud: Deals %.1f damage per second in a fog around the player, dealing %.1f damage if enemies are stunned.",
				p.getAttack() * DeathCloud.ATTACK_NORMAL_PER_SECOND,
				p.getAttack() * DeathCloud.ATTACK_BOOSTED_PER_SECOND);
	}
